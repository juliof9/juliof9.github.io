...
const GetInTouch = () => {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-home-background">
        <Form
          form={form}
          layout="vertical"
          name="contactForm"
        ...
        >
          <h2 className="text-4xl md:text-6xl lg:text-8xl font-extrabold text-white text-center mb-12 animate-fade-in-down">
